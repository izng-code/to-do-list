...
const completeToDo = function(button) {
    ...
    todoList.splice(button.getAttribute("number"),1);
    localStorage.setItem("todos", JSON.stringify(todoList));
    let container = document.querySelector(`.to-do-container[number='${button.getAttribute("number")}']`);
    container.classList.add("strike");
    setTimeout(function(){
        document.querySelector(".project-container").removeChild(container);
    }, 600);
}
