...
function drawPage(){
    ...
    for (let i = 0; i < localStorage.length; i++) {
        ...
        </svg><svg class="remove-list" listnumber="${projectContainer.getAttribute("listnumber")}" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26" height="26" viewBox="0 0 50 50">
